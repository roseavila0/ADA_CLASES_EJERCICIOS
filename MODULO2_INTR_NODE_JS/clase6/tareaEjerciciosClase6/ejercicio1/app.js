...
El objetivo de este ejercicio es que practiques cómo usar el objeto process en Node.js, tanto para acceder a variables de entorno como para
...
❌ No es necesario readline en este ejercicio, porque:

Los datos ya vienen de process.env y process.argv.
No hay interacción en tiempo real (el usuario no tiene que escribir mientras el programa corre).
Si el ejercicio solo pide leer un argumento de la terminal, entonces readline no es útil. */
...
const defaultGreeting = process.env.GREETING || "¡Hola, Hola!";
