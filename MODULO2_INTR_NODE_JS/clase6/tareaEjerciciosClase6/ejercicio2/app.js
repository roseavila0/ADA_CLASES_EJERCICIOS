...
Consigna:
En este ejercicio, escribirás un programa que muestre información útil sobre el entorno donde se está ejecutando el programa. Este ejercicio te
...
console.log(`La plataforma del sistema operativo es: ${process.platform}`);
console.log(`El directorio actual donde se ejecuta el programa es: ${process.cwd()}`);
