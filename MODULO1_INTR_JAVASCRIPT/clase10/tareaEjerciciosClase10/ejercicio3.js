...
//-----------------------------------OJO!!!! RESOLVER ESTE PROBLEMA EN TODAS LAS FORMAS POSIBLES(SUELEN TOMARLO EN ENTREVISTAS)-----------------------------
// < >
...
if (edad >= EDAD_MINIMA && edad <= EDAD_MAXIMA) {
    console.log('¡Hola! Estas dentro del rango de edad permitida.');
} else {
    console.log('¡Hola! No estas dentro del rango de edad permitida.');
}
